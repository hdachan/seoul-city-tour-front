...
export const fetchGuideLockStatus = () => axios.get(`${BASE_URL}/guide-form/lock-status`, authHeader());
export const fetchGuideRecords    = () => axios.get(`${BASE_URL}/guide-form/records`, authHeader());
export const addGuideRecord       = (data) => axios.post(`${BASE_URL}/guide-form/records`, data, authHeader());
export const updateGuideRecord    = (id, data) => axios.put(`${BASE_URL}/guide-form/records/${id}`, data, authHeader());
export const deleteGuideRecord    = (id) => axios.delete(`${BASE_URL}/guide-form/records/${id}`, authHeader());
export const fetchGuideExpense    = () => axios.get(`${BASE_URL}/guide-form/expense`, authHeader());
export const addGuideExpense      = (data) => axios.post(`${BASE_URL}/guide-form/expense`, data, authHeader());
export const updateGuideExpense   = (id, data) => axios.put(`${BASE_URL}/guide-form/expense/${id}`, data, authHeader());
export const deleteGuideExpense   = (id) => axios.delete(`${BASE_URL}/guide-form/expense/${id}`, authHeader());
export const fetchGuideDailyFee   = () => axios.get(`${BASE_URL}/guide-form/daily-fee`, authHeader());
export const addGuideDailyFee     = (amount, date) => axios.post(`${BASE_URL}/guide-form/daily-fee`, { amount, date }, authHeader());
export const updateGuideDailyFee  = (id, amount, date) => axios.put(`${BASE_URL}/guide-form/daily-fee/${id}`, { amount, date }, authHeader());
export const deleteGuideDailyFee  = (id) => axios.delete(`${BASE_URL}/guide-form/daily-fee/${id}`, authHeader());

// 관리자용 가이드 정산
export const fetchAdminGuideList      = () => axios.get(`${BASE_URL}/guide-admin/guides`, authHeader());
export const fetchAdminSummary        = (year, month) =>
  axios.get(`${BASE_URL}/guide-admin/summary`, { ...authHeader(), params: { year, month } });
export const fetchAdminLockStatus     = (guideUsername, year, month) =>
  axios.get(`${BASE_URL}/guide-admin/lock-status`, { ...authHeader(), params: { guideUsername, year, month } });
export const toggleMonthLock          = (guideUsername, year, month, locked) =>
  axios.post(`${BASE_URL}/guide-admin/lock`, { guideUsername, year, month, locked }, authHeader());
export const fetchAdminGuideIncome    = (guideUsername, year, month) =>
  axios.get(`${BASE_URL}/guide-admin/income`, { ...authHeader(), params: { guideUsername, year, month } });
export const addAdminIncome           = (data) => axios.post(`${BASE_URL}/guide-admin/income`, data, authHeader());
export const updateAdminIncome        = (id, data) => axios.put(`${BASE_URL}/guide-admin/income/${id}`, data, authHeader());
export const deleteAdminIncome        = (id) => axios.delete(`${BASE_URL}/guide-admin/income/${id}`, authHeader());
export const fetchAdminGuideExpense   = (guideUsername, year, month) =>
  axios.get(`${BASE_URL}/guide-admin/expense`, { ...authHeader(), params: { guideUsername, year, month } });
export const addAdminExpense          = (data) => axios.post(`${BASE_URL}/guide-admin/expense`, data, authHeader());
export const updateAdminExpense       = (id, data) => axios.put(`${BASE_URL}/guide-admin/expense/${id}`, data, authHeader());
export const deleteAdminExpense       = (id) => axios.delete(`${BASE_URL}/guide-admin/expense/${id}`, authHeader());
export const fetchAdminGuideDailyFee  = (guideUsername, year, month) =>
  axios.get(`${BASE_URL}/guide-admin/daily-fee`, { ...authHeader(), params: { guideUsername, year, month } });
export const addAdminDailyFee         = (data) => axios.post(`${BASE_URL}/guide-admin/daily-fee`, data, authHeader());
export const updateAdminDailyFee      = (id, amount, date) =>
  axios.put(`${BASE_URL}/guide-admin/daily-fee/${id}`, { amount, date }, authHeader());
export const deleteAdminDailyFee      = (id) => axios.delete(`${BASE_URL}/guide-admin/daily-fee/${id}`, authHeader());
